...
<main class="form-signin w-100 m-auto">
  <form action="<%= request.getContextPath() %>/login.jsp" method="post">
    ...
    <div class="form-floating">
      <input type="text" class="form-control" id="floatingInput" placeholder="아이디" name="memberId" />
      <label for="floatingInput">아이디</label>
    </div>
    <div class="form-floating">
      <input type="text" class="form-control" id="floatingPassword" placeholder="이메일" name="email" value="<%=email %>" >
